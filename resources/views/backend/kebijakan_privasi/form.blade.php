                ...
                <div class="card-body">
                    <form action="{{url('/back-kebijakan-privasi/update',$getDetailKP->id)}}" method="POST">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea name="desc" id="desc" rows="5" placeholder="Deskripsi kebijakan privasi" class="form-control @error('desc') is-invalid @enderror">{{$getDetailKP->deskripsi}}</textarea>
                            @error('desc')
