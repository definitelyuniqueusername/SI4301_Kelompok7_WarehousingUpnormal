...
<div class="limiter">
    <div class="container-register100">
        ...
        <div class="row m-auto p-3 py-4" style="background-color: white; border-radius: 15px;">
            <div class="col-12">       
                <form  method="POST" action="<?php echo e(route('register')); ?>" class=" validate-form">
                  <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus  placeholder="Nama Lenkap">
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="wrap-input100 validate-input">
                    <input id="telepon" type="telepon" class="input100 <?php $__errorArgs = ['telepon'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="telepon" required autocomplete="telepon" placeholder="No Telepon">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TUBESWADFINAL\resources\views/auth/register.blade.php ENDPATH**/ ?>