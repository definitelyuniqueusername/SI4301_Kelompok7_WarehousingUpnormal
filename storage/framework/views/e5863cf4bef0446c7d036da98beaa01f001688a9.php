<?php $__env->startSection('title', "Pilih pembayaran"); ?>

<?php $__env->startSection('frontend-content'); ?>
<form action="<?php echo e(url('/pembayaran/bayar')); ?>" method="POST">
  <?php echo csrf_field(); ?>
  <div class="container">
          ...
          <div class="card">
            <div class="card-header" id="faqhead1">
              <a href="#" class="btn btn-header-link collapsed text-head-3" data-toggle="collapse" data-target="#faq1"
                ...
                <div class="row">
                  <div class="col-md-1"><img src="<?php echo e(asset('frontend/images/kartu/kartu_kredit.svg')); ?>" alt="" srcset=""></div>
          ...
          <div class="card">
            <div class="card-header" id="faqhead2">
              <a href="#" class="btn btn-header-link collapsed text-head-3" data-toggle="collapse" data-target="#faq2"
                ...
                <div class="row">
                  <div class="col-md-1"><img src="<?php echo e(asset('frontend/images/kartu/transfer_manual.svg')); ?>" alt="" srcset=""></div>
          ...
          <div class="card">
            <div class="card-header" id="faqhead3">
              <a href="#" class="btn btn-header-link collapsed text-head-3" data-toggle="collapse" data-target="#faq3"
                ...
                <div class="row">
                  <div class="col-md-1"><img src="<?php echo e(asset('frontend/images/kartu/virutal_acoount.svg')); ?>" alt="" srcset=""></div>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <img src="<?php echo e(asset('frontend/images/kartu/bca.png')); ?>" alt="">
                      </div>
                      <div class="col-md-8">
                    ...
                    <div class="row mt-3">
                      <div class="col-md-3">
                        <img src="<?php echo e(asset('frontend/images/kartu/mandiri.png')); ?>" alt="">
                      </div>
                      <div class="col-md-8">
                    ...
                    <div class="row mt-3">
                      <div class="col-md-3">
                        <img src="<?php echo e(asset('frontend/images/kartu/bri.png')); ?>" alt="">
                      </div>
                      <div class="col-md-8">
                    ...
                    <div class="row mt-3">
                      <div class="col-md-3">
                        <img src="<?php echo e(asset('frontend/images/kartu/danamon.png')); ?>" alt="">
                      </div>
                      <div class="col-md-8">
                    ...
                    <div class="row mt-3">
                      <div class="col-md-3">
                        <img src="<?php echo e(asset('frontend/images/kartu/bni.png')); ?>" alt="">
                      </div>
                      <div class="col-md-8">
                    ...
                    <div class="row mt-3">
                      <div class="col-md-3">
                        <img src="<?php echo e(asset('frontend/images/kartu/btpn.png')); ?>" alt="">
                      </div>
                      <div class="col-md-8">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TUBESWADFINAL\resources\views/frontend/pembayaran.blade.php ENDPATH**/ ?>